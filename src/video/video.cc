...
auto Video::get_pixel_from_line(u8 byte1, u8 byte2, u8 pixel_index) const -> DmgLogicalColor {
...
auto Video::load_palette(ByteRegister& palette_register) const -> DmgPalette {
...
auto Video::get_color_from_palette(DmgLogicalColor color, const DmgPalette& palette) -> DmgColor {
    switch (color) {
...
auto Video::get_real_color(u8 pixel_value) const -> DmgColor {
    switch (pixel_value) {
